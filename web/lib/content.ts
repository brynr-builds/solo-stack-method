...
// Retrieve single items by directly reading the specific file using a sanitized slug
// rather than reading and parsing the entire directory to find a match.
// This reduces disk I/O and parsing time from O(N) to O(1) for single article retrieval.
