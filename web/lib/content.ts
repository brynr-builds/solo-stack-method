...
export function getArticle(type: ContentType, slug: string): Article | undefined {
  // ⚡ Bolt: Direct file read to avoid O(N) performance hit from parsing all articles
  // Avoids reading and parsing every single markdown file just to find one slug
