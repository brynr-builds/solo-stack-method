...
export function getArticle(type: ContentType, slug: string): Article | undefined {
  // ⚡ PERFORMANCE OPTIMIZATION: Avoid O(N) directory reads and markdown parsing.
  // We read the specific file directly using a sanitized slug, avoiding O(N) disk I/O and CPU bottlenecks.
